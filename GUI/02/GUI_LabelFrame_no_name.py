# GUI LabelFrame no name - Watch Labels within buttons_frame behaviour
#=====================================================================
# Imports
#=====================================================================
...
# Set title
win.title("GUI LabelFrame no name")
...
buttons_frame = ttk.Labelframe(win, text="") # No name to see Labels within behaviour
...
# Using loop to alter space around Labels
for child in buttons_frame.winfo_children():  # winfo_children() return a list of children
